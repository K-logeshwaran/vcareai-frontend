...
function Podcast() {
    ...
    React.useEffect(() => {
        const fetchLinks = async () => {
            try {
                const response = await fetch(`${import.meta.env.VITE_BASE_URL}/link/${OPTIONS.PODCAST}`);
                if (!response.ok) {
    ...
    return (
        <div style={{ paddingTop: "2rem" }} >
            <Typography variant='h4' component={'h1'} textAlign={'center'}>Our Latest Podcasts!</Typography>
